...
##############################################
    ...
    dataset = pd.read_csv('/home/zz/Data/wdc_data_index/wdctable_202012_index_top100_export_forML/places_with_other_class.csv')

    original = len(dataset)
    dataset.drop_duplicates(subset=['schemaorg_class', 'name_t', 'page_domain'], keep='first', inplace=True,
                        ignore_index=True)
    new = len(dataset)
...
##############################################
    ...
    dataset = pd.read_csv('/home/zz/Data/wdc_data_index/wdctable_202012_index_top100_export_forML/localBusiness_with_other_class.csv')  # localBusiness_
...
##############################################
    ...
    dataset = pd.read_csv('/home/zz/Data/wdc_data_index/wdctable_202012_index_top100_export_forML/CreativeWork_with_other_class.csv')  # localBusiness_
